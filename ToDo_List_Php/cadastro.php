...
<body class="h-100">
    <main class="d-flex align-items-center w-100 m-auto bg-secondary-subtle h-100 ">
        <div class="container bg-light text-black w-25 p-5 shadow-lg rounded">
            <h2 class="text-center text-uppercase fw-bolder mb-5">Cadastro</h2>
            <div class="container mb-3 ">
                <form action="process_cadastrar.php" method="post">
                    <div class="mt-auto">
                        <label class="container mx-1 fw-medium form-label">Nome:</label>
                        <div class="d-inline-flex w-100">
                        <input class="form-control mx-3" type="text" name="nome" id="nome" required placeholder="Damaris">
                        </div>
                        <br>
                    </div>
                    <div class="mt-auto">
                        ...
                        <div class="d-inline-flex w-100 ">
                        <input class="form-control mx-3 " type="email" name="email" id="email" required placeholder="name@exemplo.com">
                        </div>
                        <br>
                    </div>
                    <div class="mt-auto ">
